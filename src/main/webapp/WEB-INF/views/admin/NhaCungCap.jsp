              ...
              <div class="card">
                ...
                <div class="card-body">
                  <table id="tableNCC" class="table table-bordered table-striped text-center" >
                    ...
                    <tbody>
                    <c:forEach var="item" items="${dsncc}">
                      <tr>
                        <td>${item.maNCC} </td>
                        ...
                        <td>
                          <div class="d-flex justify-content-around px-4">
                            <a class="" href="/webbanhoa/quan-tri/nha-cung-cap/${item.maNCC}?linkDetail"><i
                                class="fas fa-info-circle"></i> </a>
                            <a class="" href="/webbanhoa/quan-tri/nha-cung-cap/${item.maNCC}?linkEdit" ><i
                                class="fas fa-edit"></i>
                            </a>
                            <a class="" href="" data-delete="${item.maNCC}" data-toggle="modal" data-target="#exampleModalDelete">
      ...
      <div class="modal-dialog modal-lg modal-dialog-scrollable">
        <div class="modal-content">
          <div class="modal-header bg-primary">
            <h4 class="modal-title">Thông tin nhà cung cấp ${nhaCungCap.tenNCC}</h4>
             <a href="/webbanhoa/quan-tri/nha-cung-cap" class="close" aria-label="Close"><span aria-hidden="true">&times;</span></a>
          </div>
          <div class="modal-body">
            <div class="row">
              <!-- /.col -->
              <div class="col-md-12">
                 <form:form class="form-horizontal" action="/webbanhoa/quan-tri/nha-cung-cap/${nhaCungCap.maNCC}" id="formLogin" method="get"
                    ...
                    <div class="row">
                      ...
                      <div class="col-md-12">
                        ...
                        <div class="form-group row">
                          ...
                          <div class="col-sm-10">
                          <form:input path="tenNCC" type="text" class="form-control"
								id="tenNCC" placeholder="Công ty THHH 1" />                       
                          </div>
                        </div>
                        <div class="form-group row">
                          ...
                          <form:input path="diaChi" type="text" class="form-control"
								id="diaChi" placeholder="12, Nguyễn Đình Chiểu, phường ĐaKao quận 1, HCM" />
                          </div>
                        </div>
                        <div class="form-group row">
                          <label for="sdt" class="col-sm-2 col-form-label">Liên hệ</label>
                          <div class="col-sm-10">
          ...
          <div class="modal-body">
            <div class="row">
              ...
              <div class="col-md-12">
                ...
                <form:form class="form-horizontal" action="/webbanhoa/quan-tri/nha-cung-cap" id="formLogin" method="post"
						modelAttribute="nhaCungCap">
                    <div class="row">
      ...
      <div class="modal-dialog modal-lg modal-dialog-scrollable">
        <div class="modal-content">
          <div class="modal-header bg-secondary">
            <h4 class="modal-title">Sửa nhà cung cấp ${nhaCungCap.tenNCC}</h4>
             <a href="/webbanhoa/quan-tri/nha-cung-cap" class="close" aria-label="Close"><span aria-hidden="true">&times;</span></a>
            ...
            <div class="row">
              ...
              <div class="col-md-12">
                ...
                <form:form class="form-horizontal" action="/webbanhoa/quan-tri/nha-cung-cap" id="formLogin" method="post"
                    ...
                    <div class="row">
  						<div class="col-md-12">
  						<input name="maNCC" hidden="true" value="${nhaCungCap.maNCC}">
                        <div class="form-group row">
                          <label for="tenNCC" class="col-sm-2 col-form-label">Tên NCC</label>
                          <div class="col-sm-10">
                          <form:errors path="tenNCC" cssClass="text-danger" />
 					 ...
 					 <div class="modal-footer justify-content-between">
			            ...
			            <a href="/webbanhoa/quan-tri/nha-cung-cap" 
    ...
    <div class="modal fade " id="exampleModalDelete" tabindex="-1" aria-labelledby="exampleModalDelete"
      ...
      <div class="modal-dialog ">
        <div class="modal-content">
          ...
          <form action="/webbanhoa/quan-tri/nha-cung-cap?linkDelete"  method="post">
